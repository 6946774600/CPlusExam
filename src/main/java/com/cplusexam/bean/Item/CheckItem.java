...
public class CheckItem {
	...
	private UpLoadFile upLoadFile;  //上传的图片信息
	...
	public CheckItem(String item_name, int item_imageId, String option1, String option2, String option3, String option4,
	...
	public CheckItem(int uuid, String item_name, int item_imageId, String option1, String option2, String option3,
	...
	public String toString() {
		return "CheckItem [uuid=" + uuid + ", item_name=" + item_name + ", item_imageId=" + item_imageId + ", option1="
