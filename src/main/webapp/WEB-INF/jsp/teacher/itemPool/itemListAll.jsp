...
<blockquote style="margin-top: 40px;" class="layui-elem-quote">查看所有已录入题库的选题</blockquote>
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
  ...
  <div class="layui-tab-content">
  	<div class="layui-tab-item layui-show">
  		...
  		<div style="margin-left: 20%;" id="radio_page"></div>
    ...
    <div class="layui-tab-item">
    	...
    	<div style="margin-left: 20%;" id="check_page"></div>
    ...
    <div class="layui-tab-item">
    	...
    	<div style="margin-left: 20%;" id="gap_page"></div>
    ...
    <div class="layui-tab-item">
    	...
    	<div style="margin-left: 20%;" id="judge_page"></div>
...
layui.use(['element','form','layer','laypage'], function(){
	  ...
	  $.post("${path }/teacherItemList/getItemCountForAll",{},function(res){
...
function radio_full(limit,curr,form){
	$.post("${path }/teacherItemList/getRadioItemListForAll",{limit : limit , curr : curr},function(res){
			...
			radios.forEach(function(item,index){
				var dom = $("<fieldset class='layui-elem-field' style='margin: 30px;'>"
						...
						+"&nbsp;&nbsp;录入时间：<font color='#FFB800'>"+item.create_time+"</font></legend>"
...
function check_full(limit,curr,form){
	$.post("${path }/teacherItemList/getCheckItemListForAll",{limit : limit , curr : curr},function(res){
...
function gap_full(limit,curr,form){
	$.post("${path }/teacherItemList/getGapItemListForALL",{limit : limit , curr : curr},function(res){
...
function judge_full(limit,curr,form){
	$.post("${path }/teacherItemList/getJudgeItemListForALL",{limit : limit , curr : curr},function(res){
