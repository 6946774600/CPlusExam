...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  ...
  <div class="layui-field-box">
  	<div class="layui-row">
  		<blockquote class="layui-elem-quote  layui-col-xs5 layui-col-sm5 layui-col-md5" style="padding: 20px; margin-top:100px;">
  			<font size="3">
  			本页面可以进行题库中录入题目的练习<br>
  			<hr class="layui-bg-blue">
  			点击<span class="layui-badge layui-bg-orange">开始练习</span>按钮，进行练习，已经练习的题目，不会再出现<br>
  			<hr class="layui-bg-blue">
  			点击<span class="layui-badge layui-bg-orange">清除历史</span>按钮，可将之前的练习记录清除
  			</font>
  		</blockquote>
  		<blockquote class="layui-elem-quote layui-quote-nm layui-col-md-offset1  layui-col-xs6 layui-col-sm6 layui-col-md6">
  		
  			<div class="layui-card">
			  <div class="layui-card-header">题型数量统计</div>
			  <div class="layui-card-body">
			   		<div id="echarts_itemType" style="height: 300px;"></div>
			  </div>
			</div>
		...
		<blockquote class="layui-elem-quote ">
			<div class="layui-row layui-col-space20">
			  ...
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">单选题完成状态统计&nbsp;&nbsp;&nbsp;&nbsp;<a href="${path }/studentItem/toRadioExercisePage"><button class="layui-btn layui-btn-sm">进入练习</button></a></div>
			  <div class="layui-card-body">
			   		<div id="echarts_radio1" style="height: 300px;"></div>
			  </div>
			  </div>
			  
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">单选题已完成正确率统计&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="clsRadioExercise()" class="layui-btn layui-btn-sm layui-btn-warm">清除历史</button></div>
			  <div class="layui-card-body">
			   		<div id="echarts_radio2" style="height: 300px;"></div>
			  </div>
			  </div>
		...
		<blockquote class="layui-elem-quote">
			...
			<div class="layui-row layui-col-space20">
			  ...
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">多选题完成状态统计&nbsp;&nbsp;&nbsp;&nbsp;<a href="${path }/studentItem/toCheckExercisePage"><button class="layui-btn layui-btn-sm">进入练习</button></a></div>
			  <div class="layui-card-body">
			   		<div id="echarts_check1" style="height: 300px;"></div>
			  </div>
			  </div>
			  
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">多选题已完成正确率统计&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="clsCheckExercise()" class="layui-btn layui-btn-sm layui-btn-warm">清除历史</button></div>
			  <div class="layui-card-body">
			   		<div id="echarts_check2" style="height: 300px;"></div>
			  </div>
			  </div>
		...
		<blockquote class="layui-elem-quote">
			...
			<div class="layui-row layui-col-space20">
			  ...
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">填空题完成状态统计&nbsp;&nbsp;&nbsp;&nbsp;<a href="${path }/studentItem/toGapExercisePage"><button class="layui-btn layui-btn-sm">进入练习</button></a></div>
			  <div class="layui-card-body">
			   		<div id="echarts_gap1" style="height: 300px;"></div>
			  </div>
			  </div>
			  
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">填空题已完成正确率统计&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="clsGapExercise()" class="layui-btn layui-btn-sm layui-btn-warm">清除历史</button></div>
			  <div class="layui-card-body">
			   		<div id="echarts_gap2" style="height: 300px;"></div>
			  </div>
			  </div>
		...
		<blockquote class="layui-elem-quote">
			...
			<div class="layui-row layui-col-space20">
			  ...
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">判断题完成状态统计&nbsp;&nbsp;&nbsp;&nbsp;<a href="${path }/studentItem/toJudgeExercisePage"><button class="layui-btn layui-btn-sm">进入练习</button></a></div>
			  <div class="layui-card-body">
			   		<div id="echarts_judge1" style="height: 300px;"></div>
			  </div>
			  </div>
			  
			  <div class="layui-card layui-col-xs6 layui-col-sm6 layui-col-md6">
			  <div class="layui-card-header">判断题已完成正确率统计&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="clsJudgeExercise()" class="layui-btn layui-btn-sm layui-btn-warm">清除历史</button></div>
			  <div class="layui-card-body">
			   		<div id="echarts_judge2" style="height: 300px;"></div>
			  </div>
			  </div>
...
//单选题清除历史练习按钮
function clsRadioExercise(){
	layui.use('layer',function(){
		var layer = layui.layer;
		parent.layer.confirm('您确定要删除单选题已练习记录吗?', {icon: 3, title:'提示'}, function(index){
			var url = '${path }/studentItem/clsRadioExercise';
			$.post(url,{},function (res){
				parent.layer.alert(res.msg,{title : '系统提示'},function(index){
...
//多选题清除历史按钮
function clsCheckExercise(){
	layui.use('layer',function(){
		var layer = layui.layer;
		parent.layer.confirm('您确定要删除多选题已练习记录吗?', {icon: 3, title:'提示'}, function(index){
			var url = '${path }/studentItem/clsCheckExercise';
			$.post(url,{},function (res){
				parent.layer.alert(res.msg,{title : '系统提示'},function(index){
					parent.layer.close(index);
					location.reload();
...
//填空题清除历史按钮
function clsGapExercise(){
	layui.use('layer',function(){
		var layer = layui.layer;
		parent.layer.confirm('您确定要删除填空题已练习记录吗?', {icon: 3, title:'提示'}, function(index){
			var url = '${path }/studentItem/clsGapExercise';
			$.post(url,{},function (res){
				parent.layer.alert(res.msg,{title : '系统提示'},function(index){
					parent.layer.close(index);
					location.reload();
...
//判断题清除历史按钮
function clsJudgeExercise(){
	layui.use('layer',function(){
		var layer = layui.layer;
		parent.layer.confirm('您确定要删除判断题已练习记录吗?', {icon: 3, title:'提示'}, function(index){
			var url = '${path }/studentItem/clsJudgeExercise';
			$.post(url,{},function (res){
				parent.layer.alert(res.msg,{title : '系统提示'},function(index){
					parent.layer.close(index);
					location.reload();
	...
	//考题状态图表
	$.post("${path }/studentItem/getItemTypeEc",{},function(res){
		var itemTypeDate=[];
		res.extend.itemTypeDate.forEach(function(item,index){
			itemTypeDate.push({"name":item.NAME , "value" : item.VALUE});
		});
		var myChart = echarts.init(document.getElementById('echarts_itemType'));
	...
	//单选题echarts填充
	$.post("${path }/studentItem/getRadioItemEc",{},function(res){
		var myChart1 = echarts.init(document.getElementById('echarts_radio1'));
		var scale = 1;
		var echartData = [{
		    value: res.extend.exercised,
		    name: '已练习单选题'
		}, {
		    value: res.extend.surplusCount,
		    name: '未练习单选题'
		}]
		var rich = {
		    yellow: {
		...
		option2 = {
			    ...
			    series: [{
			        ...
			        data: [{
			            value: (res.extend.trueCount+res.extend.falseCount)!=0?parseInt((res.extend.trueCount/(res.extend.trueCount+res.extend.falseCount))*100):0,
			            name: '正确率',
			        }]
		...
		var myChart2 = echarts.init(document.getElementById('echarts_radio2'));
	...
	//多选题eacharts填充
	$.post("${path }/studentItem/getCheckItemEc",{},function(res){
		var myChart1 = echarts.init(document.getElementById('echarts_check1'));
		var scale = 1;
		var echartData = [{
		    value: res.extend.exercised,
		    name: '已练习多选题'
		...
		var myChart2 = echarts.init(document.getElementById('echarts_check2'));
		myChart2.setOption(option2);
	...
	//填空题eacherts图标填充
	$.post("${path }/studentItem/getGapItemEc",{},function(res){
		var myChart1 = echarts.init(document.getElementById('echarts_gap1'));
		var scale = 1;
		var echartData = [{
		    value: res.extend.exercised,
		    name: '已练习填空题'
		...
		var myChart2 = echarts.init(document.getElementById('echarts_gap2'));
		myChart2.setOption(option2);
	...
	$.post("${path }/studentItem/getJudgeItemEc",{},function(res){
		var myChart1 = echarts.init(document.getElementById('echarts_judge1'));
		var scale = 1;
		var echartData = [{
		    value: res.extend.exercised,
		    name: '已练习判断题'
		...
		var myChart2 = echarts.init(document.getElementById('echarts_judge2'));
		myChart2.setOption(option2);
